...
async function main() {
  const concreteItems: Array<{ name: string; category: string }> = [
    ...
    { name: 'Lichen on stone', category: 'trees-plants' },
    { name: 'Cherry blossom', category: 'trees-plants' },
    ...
    { name: 'Daisy', category: 'trees-plants' },
    ...
    { name: 'Ant trail', category: 'animals-insects' },
    ...
    { name: 'Bird nest', category: 'animals-insects' },
    ...
    { name: 'Rabbit droppings', category: 'animals-insects' },
    { name: 'Woodpecker holes', category: 'animals-insects' },
    { name: 'Birdsong', category: 'animals-insects' },
    // Landscape & Features
    { name: 'Cloud shape', category: 'landscape-features' },
    { name: 'Old stone wall', category: 'landscape-features' },
    { name: 'Fallen branch', category: 'landscape-features' },
    { name: 'Twisted tree', category: 'landscape-features' },
    { name: 'Split in bark', category: 'landscape-features' },
    ...
    { name: 'Patch of wildflowers', category: 'landscape-features' },
    { name: 'Forked tree trunk', category: 'landscape-features' },
    { name: 'Knobbly root', category: 'landscape-features' },
    { name: 'Peeling bark', category: 'landscape-features' },
    ...
    { name: 'Team star jump', category: 'activities-challenges' },
    { name: 'Leaf crown', category: 'activities-challenges' },
    { name: 'Stick tower', category: 'activities-challenges' },
    { name: 'Nature face art', category: 'activities-challenges' },
    { name: 'Tree hug photo', category: 'activities-challenges' },
    { name: 'Bark rubbing', category: 'activities-challenges' },
    ...
    { name: 'Longest worm', category: 'activities-challenges' },
    { name: 'Big stick', category: 'activities-challenges' },
    { name: 'Team bridge pose', category: 'activities-challenges' },
    { name: 'Nature letter "S"', category: 'activities-challenges' },
    { name: 'Nature crown', category: 'activities-challenges' },
    // Scavenger Finds
    { name: 'Something camouflaged', category: 'scavenger-finds' },
